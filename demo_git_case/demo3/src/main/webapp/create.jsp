...
<div class="container form-container">
    ...
    <form action="?action=create" method="post">
        <fieldset class="custom-fieldset mb-4">
            ...
            <input type="text" id="yourname" name="name" class="form-control" placeholder="Nhập tên sinh viên" required>
        </fieldset>

        <fieldset class="custom-fieldset mb-4">
            <legend><h3 class="custom-title">EMAIL</h3></legend>
            <input type="text" id="youremail" name="email" class="form-control" placeholder="Nhập email sinh viên" required>
        </fieldset>

        <fieldset class="custom-fieldset mb-4">
            <legend><h3 class="custom-title">GIỚI TÍNH</h3></legend>
            <div class="form-check form-check-inline">
                <input type="radio" class="form-check-input" value="1" name="gender" required>
                <label class="form-check-label">Nam</label>
            </div>
            <div class="form-check form-check-inline">
                <input type="radio" class="form-check-input" value="0" name="gender" required>
        ...
        <fieldset class="custom-fieldset mb-4">
            ...
            <input type="number" name="point" step="0.01" class="form-control" placeholder="Nhập điểm đầu vào" required>
        </fieldset>

        <fieldset class="custom-fieldset mb-4">
            <legend><h3 class="custom-title">TÊN LỚP</h3></legend>
            <select name="class_id" required class="form-control">
                <option value="TenLop">Chọn lớp</option>
